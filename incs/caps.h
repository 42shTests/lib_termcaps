...
# define CAPS__KEYCODE_CTRL_SPACE			STRING_TO_BUFFER("\x00")
# define CAPS__KEYCODE_CTRL_A				STRING_TO_BUFFER("\x01")
# define CAPS__KEYCODE_CTRL_B				STRING_TO_BUFFER("\x02")
# define CAPS__KEYCODE_CTRL_C				STRING_TO_BUFFER("\x03")
# define CAPS__KEYCODE_CTRL_D				STRING_TO_BUFFER("\x04")
# define CAPS__KEYCODE_CTRL_E				STRING_TO_BUFFER("\x05")
# define CAPS__KEYCODE_CTRL_F				STRING_TO_BUFFER("\x06")
# define CAPS__KEYCODE_CTRL_G				STRING_TO_BUFFER("\x07")
# define CAPS__KEYCODE_CTRL_H				STRING_TO_BUFFER("\x08")
# define CAPS__KEYCODE_CTRL_I				STRING_TO_BUFFER("\x09")
# define CAPS__KEYCODE_CTRL_J				STRING_TO_BUFFER("\x0a")
# define CAPS__KEYCODE_CTRL_K				STRING_TO_BUFFER("\x0b")
# define CAPS__KEYCODE_CTRL_L				STRING_TO_BUFFER("\x0c")
# define CAPS__KEYCODE_CTRL_M				STRING_TO_BUFFER("\x0d")
# define CAPS__KEYCODE_CTRL_N				STRING_TO_BUFFER("\x0e")
# define CAPS__KEYCODE_CTRL_O				STRING_TO_BUFFER("\x0f")
# define CAPS__KEYCODE_CTRL_P				STRING_TO_BUFFER("\x10")
# define CAPS__KEYCODE_CTRL_Q				STRING_TO_BUFFER("\x11")
# define CAPS__KEYCODE_CTRL_R				STRING_TO_BUFFER("\x12")
# define CAPS__KEYCODE_CTRL_S				STRING_TO_BUFFER("\x13")
# define CAPS__KEYCODE_CTRL_T				STRING_TO_BUFFER("\x14")
# define CAPS__KEYCODE_CTRL_U				STRING_TO_BUFFER("\x15")
# define CAPS__KEYCODE_CTRL_V				STRING_TO_BUFFER("\x16")
# define CAPS__KEYCODE_CTRL_W				STRING_TO_BUFFER("\x17")
# define CAPS__KEYCODE_CTRL_X				STRING_TO_BUFFER("\x18")
# define CAPS__KEYCODE_CTRL_Y				STRING_TO_BUFFER("\x19")
# define CAPS__KEYCODE_CTRL_Z				STRING_TO_BUFFER("\x1a")
# define CAPS__KEYCODE_CTRL_CURSOR_LEFT			STRING_TO_BUFFER("\x1b\x5b\x31\x3b\x35\x44")
# define CAPS__KEYCODE_CTRL_CURSOR_RIGHT		STRING_TO_BUFFER("\x1b\x5b\x31\x3b\x35\x43")
# define CAPS__KEYCODE_CTRL_CURSOR_UP			STRING_TO_BUFFER("\x1b\x5b\x31\x3b\x35\x41")
# define CAPS__KEYCODE_CTRL_CURSOR_DOWN			STRING_TO_BUFFER("\x1b\x5b\x31\x3b\x35\x42")
